...
import { get_verifier_data, stake_rpt, unstake_rpt, transfer_verifier_address, get_categories } from "@/services/verifiers.service";
...
export default function VerifierPanel() {
     ...
     return (
       <div className="min-h-screen flex items-center justify-center bg-slate-50 dark:bg-slate-950/50">
         <div className="text-center p-8 bg-white dark:bg-slate-900 rounded-3xl shadow-xl border border-slate-100 dark:border-slate-800 max-w-md">
           ...
           <p className="text-slate-500 dark:text-slate-400 mb-6">Your address {address.slice(0,6)}...{address.slice(-4)} is not registered as a verifier in our system.</p>
           <button onClick={() => window.location.href = '/'} className="px-6 py-2 bg-indigo-600 text-white rounded-xl font-bold">Return Home</button>
         </div>
       </div>
     );
  }
  ...
  const verifier = {
    name: "Marcus Aurelius", // This could come from backend if needed
    ...
    stats: {
      ...
      totalParticipated: 0 // Need to track this separately or from events
    },
    jobs: [] // Jobs would need to be fetched from contract or events
  };
          ...
          <div className="lg:col-span-4 space-y-8">
               ...
               <div className="space-y-4">
                 <div className="flex items-center justify-between">
                   ...
                   <div className="text-right">
                     ...
                     <div className="flex items-center justify-end text-sm font-black text-indigo-600">
            ...
            <div className="bg-slate-900 dark:bg-white rounded-3xl p-8 text-white dark:text-slate-900 shadow-xl relative overflow-hidden">
               ...
               <div className="grid grid-cols-1 gap-6 relative z-10">
                 <div>
                   <p className="text-3xl font-black mb-1">{Number(verifier.stats.totalStaked).toLocaleString()} <span className="text-sm font-medium opacity-60">RP</span></p>
            ...
            <div className="bg-white dark:bg-slate-900 rounded-3xl p-8 border border-slate-100 dark:border-slate-800 shadow-sm space-y-6">
              ...
              <div className="space-y-3">
                <p className="text-[10px] uppercase font-black text-slate-400 tracking-widest">Stake RP Tokens</p>
                <div className="flex gap-2">
                  <div className="relative flex-grow">
                    ...
                    />
                    <span className="absolute right-4 top-3.5 text-[10px] font-black text-slate-400">RPT</span>
                  </div>
                  <button 
                    onClick={handleStake}
                  ...
                  >
                    {actionLoading ? <div className="w-4 h-4 border-2 border-white/30 border-t-white rounded-full animate-spin mr-2"></div> : <ArrowUpCircle className="w-4 h-4 mr-2" />}
                    Stake
                  </button>
                </div>
              </div>
              ...
              <div className="pt-4 border-t border-slate-50 dark:border-slate-800">
                ...
                >
                  {actionLoading ? <div className="w-4 h-4 border-2 border-white/30 border-t-white rounded-full animate-spin mr-2"></div> : <ArrowDownCircle className="w-4 h-4 mr-2" />}
                  Unstake All Tokens
                </button>
                <p className="text-[10px] text-slate-400 mt-3 text-center font-medium">Warning: Unstaking will set your level to minimum and may affect active disputes.</p>
              </div>

              {/* Transfer Address */}
              <div className="pt-6 border-t border-slate-50 dark:border-slate-800 space-y-3">
                <p className="text-[10px] uppercase font-black text-slate-400 tracking-widest">Transfer Verifier Address</p>
                <div className="flex gap-2">
                  <div className="relative flex-grow">
                    <input 
                      type="text" 
