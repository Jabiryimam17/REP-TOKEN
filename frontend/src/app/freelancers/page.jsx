  ...
  const freelancers = [
    {
      ...
      rank: "Top Rated Plus",
      avatar: "SC",
      title: "Senior Full Stack & Smart Contract Engineer",
      description: "Expert in developing complex DeFi protocols and scalable web applications. Over 8 years of experience in the industry with a focus on security and performance.",
      skills: ["Solidity", "React", "Node.js", "Web3.js", "Foundry"],
      minWage: 85,
      currency: "USDC",
      stats: {
        successRate: 100,
    ...
    },
    {
      ...
      rank: "Top Rated",
      avatar: "MT",
      title: "UI/UX Designer & Frontend Expert",
      description: "I build beautiful, high-converting interfaces for blockchain companies. Specialist in dark mode design and responsive layouts that work everywhere.",
      skills: ["Figma", "Tailwind CSS", "Next.js", "Three.js", "Adobe Suite"],
      minWage: 65,
      currency: "USDC",
      stats: {
        successRate: 98,
    ...
    },
    {
      ...
      description: "Dedicated to making Web3 safer. I provide deep smart contract audits and formal verification to protect protocols and their users.",
      skills: ["Solidity", "Rust", "Slither", "Mythril", "Formal Methods"],
      minWage: 120,
      currency: "USDC",
      stats: {
        successRate: 100,
    ...
    },
    {
      ...
      rank: "Expert",
      avatar: "DK",
      title: "Backend Specialist & DevOps Engineer",
      description: "Scaling infrastructure for the next billion users. Expert in Kubernetes, AWS, and building robust microservices that never go down.",
      ...
      <div className="max-w-7xl mx-auto">
            ...
            <div className="mt-6 p-8 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl shadow-xl animate-in fade-in slide-in-from-top-4 duration-300">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div>
                  ...
                  <select className="w-full p-3 bg-slate-50 dark:bg-slate-800 border border-slate-100 dark:border-slate-700 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500">
        ...
        <div className="flex items-center justify-between mb-8">
          <p className="text-slate-500 dark:text-slate-400 font-medium">
            Showing <span className="font-bold text-slate-900 dark:text-white">{freelancers.length}</span> professionals
          </p>
                  ...
                  <div className="flex items-start justify-between mb-4">
                    <div className="flex items-center">
                      <div className="relative">
                        <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-indigo-500 to-blue-600 flex items-center justify-center text-white font-bold text-2xl shadow-lg group-hover:scale-105 transition-transform">
                          {freelancer.avatar}
                        </div>
                        {freelancer.verified && (
                ...
                <div className="md:w-72 flex flex-col justify-between border-t md:border-t-0 md:border-l border-slate-100 dark:border-slate-800 pt-6 md:pt-0 md:pl-8">
                  <div className="space-y-4 mb-6">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-lg font-black text-slate-900 dark:text-white">{freelancer.minWage} {freelancer.currency}/hr</span>
                    </div>
                    
                    <div className="grid grid-cols-2 gap-3">
                      <div className="p-3 bg-slate-50 dark:bg-slate-800/50 rounded-xl">
                        <p className="text-[10px] font-bold text-slate-400 uppercase mb-1">Success</p>
                        <p className="text-sm font-black text-emerald-600">{freelancer.stats.successRate}%</p>
                      </div>
                      <div className="p-3 bg-slate-50 dark:bg-slate-800/50 rounded-xl">
                        <p className="text-[10px] font-bold text-slate-400 uppercase mb-1">Jobs</p>
                        <p className="text-sm font-black text-slate-900 dark:text-white">{freelancer.stats.totalJobs}</p>
                      </div>
                    </div>
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center justify-between text-[11px] font-bold">
                        ...
                        <span className="text-slate-700 dark:text-slate-300">{freelancer.stats.successfulJobs}</span>
                      </div>
                      <div className="flex items-center justify-between text-[11px] font-bold">
                        <span className="text-slate-500 flex items-center">
                        ...
                        <span className="text-slate-700 dark:text-slate-300">{freelancer.stats.lostDisputes}</span>
                      </div>
                    </div>
                  </div>

                  <div className="space-y-3">
                    <button className="w-full py-3 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl font-bold text-sm shadow-lg shadow-indigo-100 dark:shadow-none transition-all flex items-center justify-center group/btn">
