...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener } from "../common.js"
  ...
  export interface TempErrorsInterface extends Interface {
  ...
  export interface TempErrors extends BaseContract {
    
    connect(runner?: ContractRunner | null): TempErrors;
    waitForDeployment(): Promise<this>;

    interface: TempErrorsInterface;
